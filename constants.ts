...
export const ROUTES = {
  ...
  CUSTOMIZE_ACCOUNT: {
    id: 'CUSTOMIZE_ACCOUNT',
    name: 'CustomizeAccount' as 'CustomizeAccount',
  },
  ACCOUNT: {
    id: 'Account',
  ...
  IMPORT_KEY: {
    id: 'IMPORT_KEY',
    name: 'ImportKey' as 'ImportKey',
  },
  CUSTOMIZE_READ_ACCOUNT: {
    id: 'CUSTOMIZE_READ_ACCOUNT',
    name: 'CustomizeReadAccount' as 'CustomizeReadAccount',
  },
  IMPORT_READ_ACCOUNT: {
    id: 'IMPORT_READ_ACCOUNT',
    name: 'ImportReadAccount' as 'ImportReadAccount',
  },
  PASSPHRASE: {
    id: 'PASSPHRASE',
    name: 'Passphrase' as 'Passphrase',
  },
}
