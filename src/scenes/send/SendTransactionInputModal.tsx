...
import {ButtonView, ImageView, InputTextView, LinearLayout, TextView} from '~src/styles/styled-components'
...
const PriorityTab = () => {
  ...
  return (
    <LinearLayout orientation="horiz" bg="background.1" borderRadius={8} mb="58px" height="75px">
      <ButtonView
      ...
      >
        <LinearLayout orientation="horiz" alignItems="center">
          <ImageView
            source={priority === Priority.FAST ? priorityIconActive : priorityIconInactive}
          />
          <LinearLayout ml="8px">
            <TextView
      ...
      >
        <LinearLayout orientation="horiz" alignItems="center">
          <ImageView
            source={priority === Priority.FASTER ? priorityIconActive : priorityIconInactive}
          />
          <LinearLayout ml="8px">
            <TextView
      ...
      >
        <LinearLayout orientation="horiz" alignItems="center">
          <ImageView
            source={priority === Priority.FASTEST ? priorityIconActive : priorityIconInactive}
          />
          <LinearLayout ml="8px">
            <TextView
  ...
  return (
    <Fragment>
      ...
      <InputWithValidation
        ...
        hideScan={true}
      />
      <LinearLayout orientation="horiz" justifyContent="space-between" mt="24px" px="12px">
        <LinearLayout orientation="horiz" alignItems="center">
    ...
    >
      <ScrollView>
        ...
        >
          ...
          <DestinationAddressField theme={theme} address={text} setAddress={setText} />
          ...
          <LinearLayout mb="58px" px="24px" alignSelf="center" width="100%">
            <ThemedButton label={Facade.t('app.next')} />
          </LinearLayout>
        </LinearLayout>
      </ScrollView>
    </SwiperPanel>
