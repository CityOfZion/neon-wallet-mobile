...
export const SignTransactionFailed = ({ errorMessage }: TransactionRequestFailedElementProps) => {
      ...
      <LinearLayout height="100%" width="100%" justifyContent="space-between">
        <LinearLayout height="100%" justifyContent="center">
          <LinearLayout alignItems="center" width="100%">
            ...
            <TextView color="text.6" fontSize={14} fontWeight={500} fontFamily="medium" textAlign="center" mb={4}>
