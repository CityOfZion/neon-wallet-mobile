...
const DappConnectedCard = ({ dAppName, footer, iconUri, approvedDate, onPress }: DappConnectedCardProps) => {
          ...
          <LinearLayout>
            {!!approvedDate && (
              <TextView color="text.10" fontSize="12px">
                {moment.unix(approvedDate).format(I18n.t('formatters.dappApprovedDate'))}
              </TextView>
            )}
