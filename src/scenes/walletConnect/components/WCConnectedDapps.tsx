...
import { FlatList, ListRenderItemInfo, ScrollView, TouchableWithoutFeedback } from 'react-native'
...
export const WCConnectedDapps = () => {
  ...
  return (
    <AwaitActivity name="getConnectedDapps" loadingView={<ScreenLoader solidColorBG />}>
