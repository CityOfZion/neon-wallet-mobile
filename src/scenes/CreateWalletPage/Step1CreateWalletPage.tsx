    ...
    <ScreenLayout alignX={'center'}>
      <LinearLayout mt={5} weight={1}>
        <TextView mb={5} color={'text.0'} fontSize={'lg'} textAlign={'center'}>
          {i18n.t('step1CreateWallet.header')}
        </TextView>

        {_renderItem(
          1,
          i18n.t('step1CreateWallet.label_1'),
          i18n.t('step1CreateWallet.body_1')
        )}

        {_renderItem(
          2,
          i18n.t('step1CreateWallet.label_2'),
          i18n.t('step1CreateWallet.body_2')
        )}

        {_renderItem(
          3,
          i18n.t('step1CreateWallet.label_3'),
          i18n.t('step1CreateWallet.body_3')
        )}
      </LinearLayout>

      <LinearLayout mt={5} mb={6} px={5} width={'100%'}>
        <ThemedButton
          onPress={() => props.navigation.navigate(path.Step2CreateWallet.name)}
