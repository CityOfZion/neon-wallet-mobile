...
const PasscodeStackNavigation = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <PasscodeStack.Screen name={wrapper.route.Passcode.name} component={PasscodePage} />
        <PasscodeStack.Screen name={wrapper.route.ConfirmPasscode.name} component={ConfirmPasscodePage} />
        <PasscodeStack.Screen name={wrapper.route.VerifyPasscode.name} component={VerifyPasscodePage} />
      </PasscodeStack.Navigator>
    </ThemeProvider>
  )
}
