...
import HeaderActionButton, { HeaderActionButtonProps } from '~src/components/layout/HeaderActionButton'
...
export abstract class Navigator {
  static defaultStackNavigatorOptions(headerProps: HeaderProps): StackNavigationOptions {
